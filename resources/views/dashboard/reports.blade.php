    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">Reports are currently scan-based. Full white-label PDF rendering arrives in Phase 3.</p>
            </div>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    @forelse ($reports as $scan)
                        <tr>
                            ...
                            <td class="px-4 py-4"><span class="rounded-full bg-amber-50 px-3 py-1 text-xs font-black text-amber-700">Phase 3</span></td>
                        </tr>
                    @empty
                        <tr>
